    ...
    for da in da_strategies:  # 遍历所有数据增强策略
        for lrn_rule in lrn_rules:  # 遍历所有学习规则
            ...
            gdes_fc_on_hebb_layer_ft[str(l) + '_' + lrn_rule + '_' + ds + da_names[da]] = {
                ...
                P.KEY_NET_MDL_PATHS: [
                    P.PROJECT_ROOT + '/results/configs/vision/hebb/config_base_hebb[' + lrn_rule + '_' + ds +
            ...
            for l in range(1, num_layers[ds]):
                ...
                hebb_fc_on_hebb_layer_ft[str(l) + '_' + lrn_rule + '_' + ds + da_names[da]] = {
                    ...
                    P.KEY_PRE_NET_MODULES: ['models.hebb.model_' + str(num_layers[ds]) + 'l.Net'],
                    P.KEY_PRE_NET_MDL_PATHS: [
                        P.PROJECT_ROOT + '/results/configs/vision/hebb/gdes_fc_on_hebb_layer_ft[' + str(
                            l) + '_' + lrn_rule + '_' + ds + da_names[
                ...
                prec_on_hebb_layer[str(l) + '_' + lrn_rule + '_' + ds + da_names[da]] = {
                    ...
                    PP.KEY_COMPETITIVE_K: lrn_rule_k[lrn_rule],
                    P.KEY_PRE_NET_MODULES: ['models.hebb.model_' + str(num_layers[ds]) + 'l.Net',
                                            'models.gdes.fc2.Net'], 'mdl1:' + PP.KEY_NUM_HIDDEN: 256,
                    P.KEY_PRE_NET_MDL_PATHS: [
                        P.PROJECT_ROOT + '/results/configs/vision/hebb/config_base_hebb[' + lrn_rule + '_' + ds +
                        da_names[da] + ']/iter' + P.STR_TOKEN + '/models/model0.pt',
                        P.PROJECT_ROOT + '/results/configs/vision/hebb/gdes_fc2_on_hebb_layer[' + str(
                            l) + '_' + lrn_rule + '_' + ds + da_names[
                            da] + ']/iter' + P.STR_TOKEN + '/models/model0.pt'],
                ...
                prec_on_hebb_layer_ft[str(l) + '_' + lrn_rule + '_' + ds + da_names[da]] = {
                    ...
                    P.KEY_PRE_NET_MODULES: ['models.hebb.model_' + str(num_layers[ds]) + 'l.Net',
                                            'models.gdes.fc2.Net'], 'mdl1:' + PP.KEY_NUM_HIDDEN: 256,
                    P.KEY_PRE_NET_MDL_PATHS: [
                        P.PROJECT_ROOT + '/results/configs/vision/hebb/gdes_fc2_on_hebb_layer_ft[' + str(
                            l) + '_' + lrn_rule + '_' + ds + da_names[
                            da] + ']/iter' + P.STR_TOKEN + '/models/model0.pt',
                        P.PROJECT_ROOT + '/results/configs/vision/hebb/gdes_fc2_on_hebb_layer_ft[' + str(
                            l) + '_' + lrn_rule + '_' + ds + da_names[
                            da] + ']/iter' + P.STR_TOKEN + '/models/model1.pt'],
                    P.KEY_PRE_NET_OUTPUTS: ['bn' + str(l), 'bn1'],
                }
